...
const possibleEvents = [
    ...
    { description: "Hackers atacaram a rede ShibaMoon! Ajudar a reforçar a segurança custa dinheiro, mas pode proteger seus ativos.", investCost: 30, successChance: 0.8, successMessage: "Por pouco! A segurança foi reforçada a tempo. Você protegeu seus ativos!", successBonus: 30, failureMessage: "Droga! Os hackers foram mais rápidos. Uma pequena parte dos seus ShibaMoon foi perdida.", failurePenalty: 50 },
    ...
    { description: "Reguladores estão de olho no mercado! Uma taxa inesperada pode ser aplicada sobre seus ganhos recentes.", investCost: 50, successChance: 0.7, successMessage: "Ufa! Parece que pagar a taxa acalmou os reguladores por enquanto.", successBonus: 50, failureMessage: "Mesmo pagando a taxa, os reguladores congelaram parte dos seus ativos temporariamente!", failurePenalty: 50 },
